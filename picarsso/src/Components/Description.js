...
const Description = () => {
    return(
        <>
            ...
            <Typography vaiant="p" component="div" gutterBottom sx= {{marginTop: 2, padding: 2 , flexGrow:0, width:"90%", textAlign: "justify"}}>
            ...
            <Typography vaiant="p" component="div" gutterBottom sx= {{padding: 2 , flexGrow:0, width:"90%", textAlign: "justify"}}>
            ...
            <Typography vaiant="p" component="div" gutterBottom sx= {{padding: 2 , paddingTop: 0, flexGrow:0, width:"90%", textAlign: "justify"}}>
